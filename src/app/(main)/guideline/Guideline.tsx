...
const Guideline: React.FC = () => {
  return (
    <div className="rounded-2xl bg-card p-5 shadow-sm">
      {/* <h2 className="text-xl font-semibold mb-4">D-Pool Guidelines for Carpooling</h2> */}
      <p className="mb-4">
      ...
      <div className="my-4" /> {/* Space above Carpooling Etiquette */}
      ...
      <div className="my-4" /> {/* Space above Platform Usage */}
      ...
      <div className="my-4" /> {/* Space above Dispute Resolution */}
      ...
      <div className="my-4" /> {/* Space above Disclaimer */}
